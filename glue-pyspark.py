...
songs_file_path = f's3://{bucket_name}/spotify_data/songs/'
users_file_path = f's3://{bucket_name}/spotify_data/users/'
user_streams_path = f's3://{bucket_name}/spotify_data/user-streams'
...
song_kpi_df = user_streams_df.groupBy('track_id', 'report_date').agg(
...
song_kpis_with_details_df = song_kpi_df.join(songs_df, 'track_id')
